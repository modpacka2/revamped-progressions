...
@Mod("switchots_craft")
public class SwitchotsCraftMod {
	public static final Logger LOGGER = LogManager.getLogger(SwitchotsCraftMod.class);
	public static final String MODID = "switchots_craft";

	public SwitchotsCraftMod() {
		...
		SwitchotsCraftModMenus.REGISTRY.register(bus);
	}
