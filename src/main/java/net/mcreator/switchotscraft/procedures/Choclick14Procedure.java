...
public class Choclick14Procedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SwitchotsCraftModItems.BASIC_AXE.get()
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SwitchotsCraftModBlocks.L_14.get()) {
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = SwitchotsCraftModBlocks.CL_2.get().defaultBlockState();
				...
				if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SwitchotsCraftModItems.BASIC_AXE.get()
					...
					if (world instanceof ServerLevel _level) {
						ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(SwitchotsCraftModItems.PLANK_4.get()));
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SwitchotsCraftModBlocks.P_14.get()) {
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = SwitchotsCraftModBlocks.CL_2.get().defaultBlockState();
					BlockState _bso = world.getBlockState(_bp);
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SwitchotsCraftModBlocks.L_114.get()) {
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = SwitchotsCraftModBlocks.CL_2.get().defaultBlockState();
					BlockState _bso = world.getBlockState(_bp);
