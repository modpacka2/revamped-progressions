...
public class Chopclick56Procedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SwitchotsCraftModItems.BASIC_AXE.get()
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SwitchotsCraftModBlocks.L_56.get()) {
				{
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SwitchotsCraftModBlocks.P_56.get()) {
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = SwitchotsCraftModBlocks.CL_6.get().defaultBlockState();
					BlockState _bso = world.getBlockState(_bp);
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SwitchotsCraftModBlocks.L_156.get()) {
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = SwitchotsCraftModBlocks.CL_6.get().defaultBlockState();
					BlockState _bso = world.getBlockState(_bp);
