...
public class Chopclick96Procedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == SwitchotsCraftModItems.BASIC_AXE.get()
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SwitchotsCraftModBlocks.L_96.get()) {
				{
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SwitchotsCraftModBlocks.P_96.get()) {
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = SwitchotsCraftModBlocks.CL_10.get().defaultBlockState();
					BlockState _bso = world.getBlockState(_bp);
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SwitchotsCraftModBlocks.L_196.get()) {
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = SwitchotsCraftModBlocks.CL_10.get().defaultBlockState();
					BlockState _bso = world.getBlockState(_bp);
